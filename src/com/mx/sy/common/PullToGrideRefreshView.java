 ...
 *
 */
public class PullToGrideRefreshView extends LinearLayout {
	...
	private boolean enablePullLoadMoreDataStatus = false;
	...
	public PullToGrideRefreshView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public PullToGrideRefreshView(Context context) {
		super(context);
		init();
	}
	private void init() {
